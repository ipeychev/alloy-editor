...
YUI.add('alloy-editor', function(Y) {
    ...
    AlloyEditor = Y.Base.create('alloyEditor', Y.Base, [], {
        ...
        /**
         * Hides the toolbars if none of them or their child nodes is the current active element on the page.
         *
        ...
        ATTRS: {
             ...
             * <pre><code>
             *     toolbars: {
             *         table: { // this would be a toolbar configuration, which specifies both Toolbar attributes andits buttons
