YUI.add('toolbar-image', function(Y) {
    ...
    var Lang = Y.Lang,
        ...
        ToolbarImage = Y.Base.create('toolbarimage', Y.Widget, [Y.WidgetPosition, Y.WidgetPositionConstrain,
            ...
            /**
             * Attaches listeners to <code>actionPerformed</code> and <code>tolbarsHide</code> events.
             *
             * @method bindUI
             * @protected
             */
            bindUI: function() {
                ...
                this.get('editor').on('tolbarsHide', this._onToolbarsHide, this);
            },
            ...
            /**
             * Hides the toolbar in case of <code>tolbarsHide</code> event.
             *
